-- Fix UNION ALL syntax error

-- 1. Corrected search function without UNION syntax issues
...
-- 2. Update the embedded resource table (same as before, but ensuring it's correct)
