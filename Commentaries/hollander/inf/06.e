...
Hippolytus]).
	...
	|3.~ On the word ^trestizia~ see the gloss of Bosco/Reggio (comm.
vv. 1-3): 'si ricordi la definizione di ^trestizia~ per S. Tommaso:
"cognitio et recusatio mali" (^Summa theol~. I-IIae, q. XXXIX, a. 2)
ricordata da V. Russo, ^"Tristitia" e "misericordia" nel canto V
dell'"Inferno"~, in his ^Sussidi e esegesi dantesca~ (Naples: Liguori,
1966), pp. 33-51, per "liberare l'interpretazione del termine da ogni
residua e falsa coloritura sentimentale." But for Dante it represented
a sorrow brought on by strong emotions, such as we find recorded several
times in ^Vita Nuova~ (XXXI 1; XXXVI 2, etc.).' Combined, however, with
the 'cognati' in the preceding verse, the word has here predominantly
a sense that would seem more analytic than sentimental.

	|4-6.~ Here, for the first time, one experiences the fluidity
between the lines of demarcation between zones of the poem. These
are less rigid than a casual reader may notice. In the words of
A.M. Chiavacci Leonardi (comm. v. 4): 'The first tercet, in a position
that is syntactically dependent, serves as closure for the fifth canto;
this one [...] marks the true beginning of the sixth.'
...
for you).
	...
	|8-12.~ The details that constitute the 'hellscape' for the
gluttons are sodden and disgusting (and see the reinforcement of this
impression at vv. 46-48). We might speculate that, in his own view at
least, over-eating had had no appeal for Dante, while lust was a much
more serious threat to his soul's well-being.
...
malediction of the serpent (Genesis 3:14) concludes '... ^terram~
...
Confining ourselves to the very shortest cantos (those from 115 to 130
...
(verse 32) as antithetic to the music played at banquets, the setting in
the world above for the gluttony that is punished here. Padoan (comm. to
^Inf~. VI.32) points out that this description of the effect on the
guilty souls of Cerberus's barking mirrors the verse in Virgil describing
a similar effect: ^Aeneid~ VI.401: 'licet ingens ianitor antro / aeternum
latrans exsanguis terreat umbras' (if, from his cave, the huge gatekeeper
...
characters found in the poem, the vast majority of them in hell.
	...
	|40-42.~ This damned soul is called back to thoughts of his past
life on earth by the presence of the protagonist, whom he recognizes.
We may extrapolate from this scene what Dante intends us to consider the
experiential nature of a life of damnation: eternal fixation with one's
punishment, now interrupted by the coming of someone remembered from
the 'dolce mondo' (v. 88). This is a vivid and pleasing interruption,
but then recedes into continued and unending torment.
...
Forese Donati in ^Purgatorio~ XXIII.43.
	...
	|43.~ The vast majority of the MSS read ^lei~. Petrocchi
(^La Commedia secondo l'antica vulgata: Inf~., p. 100, objects, arguing
that they ^should~ have read ^lui~, the reading supplied in his text,
because the ^ombra~ (the understood antecedent accounting for the feminine
forms ^elle~, ^una~, and ^ella~ a few lines above -- at vv. 37-39)
has revealed itself as masculine in v. 42. This may be an example of
hypercorrect editing on Petrocchi's part.
...
^Chiose selmiane~ (comm. to ^Inf~. VI.52) have it that Ciacco was a
...
1967], p. 40).
	...
	|70-72.~ Padoan (comm. v. 70): 'The Blacks will maintain their
supremacy for ^lungo tempo~, making it weigh heavy on the defeated with
their pride, as exiled Dante knew only too well (and still he could
not imagine just how 'long' that 'time' would be). For a ^fronte alta~
as signifying pride, see ^Inf~. I.47; it is not by chance that this vice
is punished by ^gravi pesi~ in ^Purg~. XI.'
...
Dante's mind, is 
apparently considered, along with Farinata and the others named here,
as among the powerful citizens of an earlier Florence, before the city
became utterly dissolute, who maintained a proper civic concern.
See the study of Pietro Santini ("Sui fiorentini
