	|1-2. Pape~ ecc. Queste parole sono ebraiche fuor d'ogni
...
parlar ^chioccio~, quasi aperto contrassegno della loro schiatta.
	...
	|3. Che tutto seppe.~ Anche l'ebraico. Invece di
...
sconfitta, avuta da Michele, per farlo umiliare.
	...
	|12. Strupo~ per stupro. Si dice anche ^ghirlanda e
grillanda.~
...
genere.
	...
	|13-15. Quali~ ecc. Questa similitudine @e bella assai.
Essa indica l'altezza e la larghezza della superbia, e insieme la
sua improvvisa sconfitta.

	|16. Quarta lacca.~ Quarto cerchio, quarta vallea.

	|17. Prendendo~ ecc. Inoltrandomi pi@u gi@u per
l'Inferno.

	|18. Insacca.~ Accoglie tutti i peccatori e tutte le
pene del mondo.

	|19. Stipa.~  Unisce, aduna, stringe.

	|21. Nostra colpa.~ La cupidigia, detta nostra colpa per
antonomasia. ^Scipa.~ Sconcia, guasta.

	|22. Come fa~ ecc. In quello stretto tra l'Italia e la
...
quello stretto.
	...
	|24. Riddi.~ Balli, ma cos@i come l'onda di Cariddi, che
quella sopra s'urta con quella sotto, e si riversa indietro.

	|25. Pi@u che altrove troppa.~ Assai pi@u che nei cerchi
passati (escluso per@o l'atrio) perch@e la cupidigia @e pi@u
generale degli altri vizj.

	|26-28. E d'una parte~ ecc. Gli avari ed i prodighi sono
...
questo vizio porta pi@u male che gli altri puniti sopra.
	...
	|30. Gridando~ ecc.  I prodighi agli avari dicono:
...
avari ai prodighi: Perch@e mi burli tu che sei alla stessa pena?
	...
	|38-39. Alla sinistra nostra~, ecc. Dante era smontato a
...
eccesso.
	...
	|43-44. Assai~ ecc. Quel che si dice l'un l'altro al punto
...
l'offesa con dire ai prodighi: Perch@e burli?
	...
	|45. Gli dispaja.~ Perch@e l'avversione che gli uni
...
rinnovare la scena al punto opposto.
	...
	|48. In cui~ ecc. Sia ringraziato il Signore, non gi@a
...
^avarizia~ posta in questo verso.
	...
	|49. Tra questi cotali.~ Tra i prodighi e gli avari
indistintamente.

	|53. La sconoscente vita.~ La vita che non conosce la
vera e giusta misura dello spendio. E lo stesso senso che
^Guerci della mente~ detto di sopra.

	|54 Bruni.~ Impossibili a conoscere. Per conoscere un
oggetto ci vuol chiarezza.

	|56-57 Questi~ ecc.  Invece di questi e quelli si dice
anche: questi e questi.  Gli avari col pugno chiuso: i prodighi
coi crin mozzi.

	|57. Col pugno~ ecc. Qui @e detto, anche pi@u chiaro di
prima, che quelli dal crin mozzo (chierici) sono prodighi per la
ragione che quelli dal pugno chiuso sono avari.

	|58. Mal dare~ (il vizio della prodigalit@a in cui cadono
...
paradiso (^lo mondo pulcro~).
	...
	|60. Qual ella~ ecc. @E cos@i visibile e chiara per s@e
questa pena, che non occorre studiarvi dietro parole per
descriverla.

	|61. Or puoi~ ecc. Siamo qui alla solita istruzione, e
va bene, perch@e il poeta cristiano non dee fare come il gentile.
	...
	|64. Sotto la luna.~ Qui in terra, che @e sotto la luna,
perch@e la luna @e il pianeta a lei pi@u vicino. Risponde al
detto nel Canto secondo: ^Ogni contento -- Da quel ciel che ha
minor li cerchi sui.~

	|66. Posar~ @e contentare.

	|68-69. Questa fortuna~ ecc. Finge Dante di avere un'idea
...
presenti.
	...
	|74. Chi conduce.~ Segue il sistema di Tolomeo, che d@a
ad ogni cielo, che s'aggira intorno alla terra, fatta centro
dell'universo, un'Intelligenza motrice.

	|75-78. Ogni parte~ ecc. La circolazione degli astri
...
duce.~
	...
	|79. Che permutasse~ ecc. La quale Intelligenza,
...
Dio, togliesse i beni della terra agli uni per darli agli altri.
	...
	|80. Di gente in gente.~ Di nazione in nazione. Si
vegga, per esempio, la nazione greca, quanto scaduta; e prima di lei
l'Assiria, l'Egitto, la Persia, imperj cos@i possenti e cos@i doviziosi,
cos@i culti, ora caduti poco meno che nell'abbrutimento, per le permute
in discorso.  Si veggano per lo contrario le due Americhe, un tempo
tutte selvagge e immiserite, poi divenute fonti di ricchezze anche
a vantaggio del mondo antico, ed ora forse destinate a subire altre
permute a proprio danno.
...
Aristocrazia veneta ne @e un esempio che stringe il cuore.
	...
	|81. Oltre~ ecc. Senza che si possa opporsi con umani
accorgimenti. @E il ^Non est prudentia, non est consilium contra
Dominum~ (Prov. 21, 30).

	|84. Ched @e~ ecc. Qual cosa pi@u deliziosa che
...
^Ed~ per ^e.~
	...
	|86. Ella~ ecc. Sono atti che dee fare ognuno, che
amministri una cosa, un regno.

	|87. Gli altri Dei.~ Chi sono questi altri Dei? Sono le
...
sono spesso nella Scrittura chiamati Dei.
	...
	|88. Le sue~ ecc. Questa cos@i detta fortuna, che abbiam
...
parimenti chi @e ricco lo @e per poco.
	...
	|89. Necessit@a~ ecc. Perch@e si dice che: ^Necessit@a
...
soggetto su cui dee agire passa e trasvola.
	...
	|90. S@i spesso vien~ ecc. Cos@i spesso eccoti comparire
...
S. Zeno di Verona, rendono scolpito questo pensiero del poeta.
	...
	|91-93. Quest' @e colei~ ecc. Chi e quando uno si lamenta
...
tempo determinato.
	...
	|94-96. Ma ella~ ecc. Questa che si dice fortuna @e
...
Intelligenze motrici dei cieli (^con l'altre prime creature~).
	...
	|97. A maggior pi$eta.~ Quanto pi@u si discende
nell'Inferno si trovano maggiori tormenti (^maggior pi$eta~) per
colpe maggiori.

	|98-99. Gi@a ogni stella~, ecc. Virgilio si mosse I,
^Inf.~, 136:
...
ripartizione pi@u naturale e pi@u ovvia @e la seguente:
     ...
     pomeridiane. Rimangono ore 4:30 per giungere alle 12:30).
...
mia Tav. II, ^Inf.~
	...
	|100. Ricidemmo~ ecc. Trapassammo per traverso il quarto
...
ragion dell'aria, che si sprigiona dalla strozza dei parlanti.
	...
	|121. Dicon~ ecc. Ecco i lamenti che fanno.

	|122-123. Accidioso fummo.~ L'accidia @e un tedio e
...
tristezza.
	...
	|124. Or ci attristiam~ ecc. E cos@i sta bene: tristezza
per tristezza.

	|126. Nol posson~ ecc. Non posson proferire che parole
...
rivali.
	...
	|128. Tra la ripa secca, e il m$ezzo.~ La ripa secca era
...
faranno per l'Inferno.
	...
	|129. Con gli occhi volti~ ecc. A chi guardavano i poeti?
