...
diciam anche <bassar la cresta, fiaccar la cresta>, ecc.
	...
	(Nota Finale}.  E pria di tutto avviciniamoci a
...
vastissimo lago di Cocito ne aggel@o.
	...
	{Nota Finale}.  Per significarci poi che
...
il punto centrale del Globo.
	...
	{Nota Finale}.  Ci@o posto, ecco un colpo da
...
|Il cammino @e malvagio~ gli ha detto poc'anzi Virgilio, ed ei
vede di fatto che l@a ov'erano non era agevol camminata di
palagio, ma |natural burella~ che avea suol scabroso e mancanza
di lume.  Questa @e la via per la quale al monte della virt@u si
