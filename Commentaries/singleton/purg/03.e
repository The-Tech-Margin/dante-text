...
Nicom.~ IV, 3, 1125a that "motus gravis magnanimi videtur 
...
hasty step... is unbefitting to a dignified man.")
	...
	|11.  dismaga~: The verb ^dismagare~ (OFr ^esmaier~)
...
support of which see M. Barbi, 1934b, pp. 277-78), i.e., "the sun
...
is thus three hours, or 45{degrees} west of Jerusalem, and its time
...
the preceding verse comes, in such a context, to mean "to --
trace," "to go back over," proceeding from effect to God's cause
and ^modus operandi~, hence, "to understand."  In referring to
the Godhead as the Trinity, Virgil brings in another inscrutable
mystery.  See Thomas Aquinas, ^Summa theol.~ I, q. 32, a. I,
resp.:
...
or revelation, not of sin and atonement.
	...
	|41.  sarebbe~: This tense suggests that their desire
...
this would require the tense "sarebbe stato."
	...
	|44-45.  e di molt' altri... turbato~: Clearly Virgil
...
fortified town (^castello).  Turb@ia~: La Turbie, a village near
the coast in the present department of Alpes-Maritimes in
...
through which they now had to travel.")
	...
	|51.  verso di~: Cf. "verso," ^Inf.~ XXXIV, 59.  |quella~:
The "roccia" of vs. 47.
...
wall of the cliff to see if he can discern one.
	...
	|58.  da man sinistra~: The detail will take on
...
to the left, or clockwise.
	...
	|58-59.  una gente d'anime~: "Gente" suggests a grouping
...
counterclockwise.
	...
	|72.  com' a guardar, chi va dubbiando, stassi~: The
syntax of this verse has given rise to considerable discussion.
See F. D'Ovidio (1920, pp. 93-100), who lists the several
possible meanings.  The souls halt abruptly and huddle close
together, but it is their halting in order to ^look~ that is the
basis for the simile or pseudo-simile expressed by the verse.
Most probably "va dubbiando" is simply the familiar progressive
tense, while "stassi" (^si sta~) is an instance of the
"distancing" or "fixing" reflexive (the so-called pleonastic
reflexive, on which see the n. to ^Inf.~ VII, 94, and ^passim~),
matching the "stetter fermi" of the preceding verse.  As D'Ovidio
(1920, p. 100) paraphrases it, "stetter fermi, come fa chi colto
da un dubbio si sofferma a guardare."  ("They stood still, just
the way someone who is struck by a doubt will stop and gaze.")
...
vegna."
	...
	|76.  ditene~ = ^diteci.~  |dove la montagna giace~: See vs.
52.
...
the purpose of these verses.
	...
	|86.  fortunata~: Cf. ^Purg.~ II, 74: "anime fortunate."
|allotta~ = ^allora.~  Cf. ^Inf.~ V, 53 and "otta" in ^Inf.~ XI,
112.

	|88.  color dinanzi~: "Those in front," i.e., "la testa"
of vs. 85.

	|88-89.  vider rotta... canto~: Dante and his guide first
...
^fecero.~
	...
	|94.  vi confesso~: "I declare to you."  Cf. ^Inf.~ XIV,
106.
...
civ. Dei~ XXII, xix, 3: "Non enim deformitas in eis, sed
dignitas erit, et quaedam, quamvis in corpore, non corporis, sed
virtutis pulchritudo fulgebit."  ("For, in the martyrs, such
wounds will not be a deformity; they will have a dignity and
loveliness all their own; and, though this radiance will be
spiritual and not physical, it will, in some way, beam from their
bodies.")  Thus the possibility of such wounds remaining in the
"body" after death is somehow allowed.  Manfred is no martyr --
indeed, he died in contumacy of Holy Church.  And yet, in spite
of excommunication by the Church ("their malediction"), he is
...
of the living.
	...
	|115.  vadi~ = ^vada.~  |mia bella figlia~: Constance (see vs.
143), daughter of Manfred and Beatrice of Savoy.  In 1262 she
married Pedro III of Aragon, by whom she became the mother of
Alfonso (king of Aragon, 1285-91), James (king of Sicily, 1285-
95; king of Aragon, 1291-1327), and Frederick (king of Sicily,
1296-1337).  It was through his marriage with Constance that
Pedro III claimed the crown of Sicily, which he assumed in 1282
after the Sicilian Vespers.  Constance died at Barcelona in 1302,
having outlived both her husband and her eldest son.

	|115-116.  genitrice de l'onor di Cicilia e d'Aragona~:
The "honor" of Sicily (for the form ^Cicilia~, see ^Inf.~ XII,
108) is Frederick, the third son of Constance and Pedro (see n.
to vs. 115).  The "honor" of Aragon could be either Alfonso,
their eldest son, or James, their second son, who, when Alfonso
died in 1291, succeeded him in Aragon, leaving the government of
Sicily in the hands of his younger brother, Frederick, who became
king of Sicily in 1296.  In ^Purg.~ VII, 119-20 Dante expresses a
poor opinion of the worth of both Frederick and James, but (if we
assume that James rather than Alfonso is here intended) it should
be remembered that it is their grandfather who speaks of them
here as "honors."  For the view advanced by Tobler that "onor" may
mean simply ^signoria~ or, in this case, "sovereigns," see E. G.
Parodi (1901), p. 52.
...
^Inf.~ XVII, 83, and vs. 123 of the present canto: "ci@o che si
...
before his death, see F. Novati (1898), pp. 3-13.
	...
	|120.  piangendo~: With true contrition of the heart
(^contritio cordis~) for his horrible sins.  See ^Purg.~ XX,
145.
...
consider.
	...
	|128.  in co~ = ^in capo.~  Cf. ^Inf.~ X, 76; XI,
64.  |del ponte~: The bridge over the river Calore, which
flows by Benevento.
...
from which his bones must be removed.   |il Verde~: A name
commonly applied to one of the principal rivers of southern
...
extinguished.
	...
	|133-134.  Per lor maladizion... amore~: Excommunication is
referred to as a ^maledictio~ by Bonaventura, ^Comm.  Sent.~
...
Bonaventura, ^Comm. Sent. Petri Lombardi IV~ XVIII, ii, a. 1,
q. 1, ad 1, which applies to the doctrine in question:
...
setting "ecclesiastics" off as a class.
	...
	|134.  l'etterno amore~: Sanctifying grace and charity,
...
Dante's own invention.
	...
	|138-140.  star li convien... presunzion~: In conceiving
this penalty for the contumacious, Dante seems to have been
inspired by ^Aen.~ VI, 325-30, where Virgil tells of the unburied
(Manfred is one such), who are rejected by Charon:
	...
	|138.  li~ = ^gli.~  |questa ripa~: The cliff, which has also
been called a "parete," or wall, in vs. 99.

	|139-140.  per ognun tempo... presunzion~: Why thirty-fold?
Dante does not appear to be following any established doctrine in
...
helped by prayers).
	...
	|140-141.  se tal decreto... diventa~: The good prayers
must, of course, be said by someone living in grace.  Cf.
^Purg.~ IV, 133-34.
...
Purgatory among the "^spiriti eletti.~"  |e anco esto divieto~: The
prohibition that would keep him another 236 years here outside
the wall.
