	|1-3.~  Both the words ^margini~ (borders) and ^ruscello~ (stream) 
...
of fire fall and which admits no mortal traversal.
	...
	|4-12.~  The double simile compares the construction made by God to 
...
north of Padua from which the spring snows release their torrents.
	...
	|13-21.~  Another double comparison.  As the poets move away from the 
...
inclination, but not of calculated choice.
	...
	|23-24.~  The sinner, standing below Dante, must reach up to touch the 
...
refers to hell in general.
	...
	|31-42.~  Brunetto, disdainful of his fellows and glad to be able to 
...
punishment.
	...
	|48.~  A number of commentaries on this passage cite ^Aeneid~ 
...
in other words, may be entirely intentional.
	...
	|50.~  Dante's reflection upon his own lostness at the outset (^Inf~. 
...
'lostness' would become permanent, while Dante's is only temporary.
	...
	|54.~  Dante had criticized Brunetto's (along with other Tuscan 
...
well observe that the phrase refers to the goal of the voyage, God.
	...
	|55.~  Dante's 'star' is probably his natal sign, Gemini.  Brunetto 
...
pleases and let time continue its relentless course' (p. 6).
	...
	|99.~  This is Virgil's only utterance in the canto.  (Walking ahead 
...
in Dante's poem.
	...
	|121-124.~  The canto concludes with a simile that perfectly expresses 
