...
stars.  "Cielo," in this context, points specifically to the heaven
of the fixed stars, which is the eighth heaven and is above the
planetary spheres (see C. S. Singleton, ^Inferno Commentary~,
Fig. 1, p. 34).  Benvenuto comments: "^Privata~, quantum ad
aspectum nostrum, ^d'ogni pianeta~... ideo bene dicit: ^sotto
povero cielo~, quantum in apparentia, quia coelum, quod est
ditissimum tot gemmis lucentibus, tunc videtur pauperatum quando
apparet privatum pretiosissimis ornamentis suis."  ("Deprived,
that is, insofar as we can see, of any planet... hence he is right
in saying ^sotto povero cielo~, as far as appearances go, because
the heavens, so rich in so many gleaming gems, seem indeed
barren, when deprived of their most precious ornaments.")
...
fece mai."  |grosso velo~: Cf. ^Inf.~ XXXII, 25.
	...
	|5.  fummo~ = ^fumo.~  |coperse~: "Covered," in the sense
of enveloped.
...
metaphor of "velo," denoting pile, as of a woven fabric.
	...
	|8.  la scorta mia~: Virgil.  Cf. ^Purg.~ IV,
39.  |fida~: "Trustworthy."

	|8-9.  la scorta mia... m'offerse~: Virgil draws near to
Dante and offers him his shoulder, that he may rest his hand on
it and be guided, like a blind man.  This does not mean that
Virgil himself can see in the smoke.  In fact, the closing verse
of the preceding canto has it that the smoke "took from us our
sight."  Moreover, the spirits that are here being purged of
wrath are surely blinded by the smoke.  But Virgil as a wise
guide has a way of "seeing" that is not purely physical and
accordingly can lead Dante on around the terrace.

	|11.  dar di cozzo~: Literally, "to butt," i.e., to knock
one's head against.

	|12.  cosa che 'l molesti, o forse ancida~: "Molesti" and
"ancida" are hypothetical subjunctives.  |ancida~ = ^uccida.~ Cf.
^Purg.~ XIV, 133.

	|13.  m'andava io~: The so-called pleonastic reflexive,
together with the subject pronoun in this case, serves to set off the
subject Dante in his blind advance through smoke which is so painful to
the eyes and so filthy that he cannot open them to see.  |amaro~: See
Virgil, ^Aen.~ XII, 588: "fumoque implevit amaro" ("and filled it with
stinging smoke").

	|14-15.  diceva pur~: "Kept repeating."

	|15.  mozzo~: "Separated."  Cf. ^Inf.~ IX, 95; XXVIII,
19.
...
God"), it implores the mercy and peace of God.  N. Gihr
(1949, pp. 748-49) gives the following background:
...
dimandano misericordia, e lo terzo pace."  ("The first two ask for
mercy and the third for peace.")  The text intended, therefore,
must be:
...
de la pace" in ^Purg.~ XV, 131.
	...
	|18.  Agnel di Dio~: Christ as Lamb suggests innocence
and gentleness, the opposite of wrath.  |le peccata~: Cf.
^Inf.~ V, 9.

	|19.  Pur~: "Repeatedly."  Each of the verses of the
prayer begins with the words "Agnus Dei."  |essordia~: From the
...
intonation, or perhaps the same chant.
	...
	|21.  parea~ = ^appariva.~  |ogne concordia~: Such concord
among the souls, the more notable in Purgatory by being so
strikingly in contrast with the souls in Hell, is most
...
See n. to ^Inf.~ VII, 109-16.  |solvendo il nodo~: See Thomas
Aquinas, ^Summa theol.~ III, q. 84, a. 3, resp.: "Nam peccata
sunt quaedam vincula, secundum illud Proverb. 5, 22: ^Iniquitates
suae capiunt impium, et funibus peccatorum suorum quisque
constringitur.~"  ("Because sins are fetters, according to Prov.
v. 22.  ^His own iniquities catch the wicked~, ^and he is fast
bound with the ropes of his own sins.~")  In this sense, these
souls are seeking liberty here (i.e., liberation from the bonds
of sin), even as was said of Dante (^Purg.~ I, 71).  "Nodo" may
also be conceived as something that shuts out, excludes, the
...
Virgil (vs. 22) has suggested that he himself is not a spirit.
	...
	|27.  calendi~: From the Latin ^calendae.~  See E. G.
Parodi (1957), p. 248.  In Dante's time the term was still used
of the first day of the month.  Cf. ^Calendimaggio~, "May Day."
Thus Dante is said to speak as the living do, dividing tirne into
...
since time does not pass for them.")
	...
	|28.  per~ = ^da.~  |una voce~: The voice of Marco Lombardo,
as the spirit itself soon declares.
...
direction for circling the mountain?  |s@ue~ = ^su.~  Cf. ^Purg.~
IV, 47.
...
is His creature.  "Ti mondi" and "tornar bello" recall ^Purg.~ II,
75 and 122-23, the image of the snake shedding its old skin.

	|33.  se mi secondi~: I.e., if you follow the sound of my
voice and of my steps.

	|34.  quanto mi lece~: As we learn later (vss. 141-44),
the spirits must remain inside the cloud of smoke.

	|36.  giunti~ = ^congiunti.~  |in quella vece~: Cf. ^Inf.~
XXI, 10.
...
him (vs. 33).  Cf. ^Purg.~ VIII, 67-72.
	...
	|41.  veggia~ = ^veda.~  |la sua corte~: Cf. ^Inf.~ II,
125, and, in that same canto, the courtly scene in Heaven as
described by Beatrice, vss. 94-108.

	|42.  fuor del moderno uso~: Paul was caught up to Heaven
and saw God's "court," and other contemplatives also had that
...
been abandoned in modern times (^Par.~ XII, 64-75).  "Fuor del
moderno uso" points to this fact.

	|44.  dilmi~ = ^dimmelo.~  |al varco~: To the passage or
stairway leading up to the next terrace.  The passage here is
metaphorically termed a "ford."  Cf. ^Inf.~ XII, 26.
...
Venice.  "Fuit quidam miles curialis de nobili civitate Venetiarum"
("He was a certain noble knight of the illustrious city of the
Venetians"), says Benvenuto.  And some commentators assert that
he belonged to the Lombardi of Venice and that "Lombardo"
consequently was his family name.  In the ^Novelle antiche~ (see
LXXII) he is, on the other hand, described as "Marcho lonbardo,"
i.e., Marco of Lombardy.  In the ^Ottimo Commento~ it is stated
that he frequented Paris and that he was called Lombardo "alla
guisa francesca parlando" ("after the French manner of
speaking"), in which case the name would simply mean "Marco the
Italian."  Several stories are told of Marco.  Benvenuto relates,
as an indication of his temperament, how, when he had been taken
prisoner and a ransom was demanded, he applied to Rizzardo da
Camino for the required sum, and how, on learning that Rizzardo
was raising contributions from the Lombard nobles, he declared he
would sooner die in prison than be under such obligations,
whereupon Rizzardo, abashed, paid the whole sum himself.  Buti
makes special mention of his liberality, and Villani (VII, 121)
tells a story of how Marco foretold his misfortunes to Count
Ugolino, who was then at the height of his power and prosperity.
...
esperto / e de li vizi umani e del valore" (^Inf.~ XXVI, 98-
99).  |valore~: Virtue in general, as in Ulysses' words and also
in Guido del Duca's in ^Purg.~ XIV, 37.
...
its inhabitants had changed their nature to that of animals.
	...
	|56.  ne la sentenza tua~: By what you say, by your
pronouncement concerning the abandonment of virtue generally
(vss. 47-48).

	|56-57.  che mi fa certo... l'accoppio~: Which assure me
of that with which I couple it, i.e., of my persuasion (as stated
in vss. 58-59) that virtue has departed from the world.

	|57.  qui~: In what you tell me.  |e altrove~: And
by way of what another told me (i.e., Guido del Duca in ^Purg.~
XIV, 37-66).
...
^virt@u~ in this context.  |gravido e coverto~: Pregnant within
and covered without.
...
which shed their influence on mortal creatures.  |nel cielo
uno~, ^e un qua gi@u la pone~: Some assign the cause to the
heavens, others to men.  |qua gi@u~: In the living, in men.

	|64.  duolo~: Marco is grieved that mortals can be so
blind as not to see the truth which he will now set forth.
^strinse~: The sigh is "squeezed out" into an expression of
sorrow and commiseration.  |uhi~: Some editors have
...
che v'offende."  |e tu vien ben da lui~: And you certainly are
from and of the world, to hold any such doubt.

	|67.  Voi che vivete~: You, all the living.

	|67-68.  ogne cagion recate pur suso al cielo~: Persist
in assigning every cause to the heavens.

	|68.  pur come se~: "Just as if."

	|68-69.  pur come se... necessitate~: "As if they (the
heavens) moved everything with them by necessity" (i.e., with an
absolute determinism).  See Dante's ^Epist.~ XI, 4: "Et, quod
horribilius est, quod astronomi quidam et crude prophetantes
necessarium asserunt quod, male usi libertate arbitrii, eligere
maluistis."  ("And, what is more horrible, certain astronomers,
crudely prophesying, declare that to be of necessity which in
truth ye, making ill use of the liberty of the will, have rather
chosen.")

	|70.  fora~ = ^sarebbe.~

	|70-71.  fora distrutto libero arbitrio~: Free will would
be done away with.  The ^locus classicus~ of this question, one
which Dante doubtless had in mind, is Boethius, ^Consol.~
^philos.~ V, 2, II. 1-27.

	|71-72.  non fora giustizia... lutto~: It would not be
just that there should be any reward of happiness for well-doing,
or of punishment for evil-doing.  See Bonaventura, ^Collationes
de septem donis Spiritus Sancti~ VIII, 18:
...
theol.~ II-II, q. 95, a. 5, resp.):
     ...
     Anima~ iii. 4[429a], 9[432b]).  Now nobody can make an
     ...
     Philosopher shows (^De Anima~ iii. II [434a]: ^Ethic.~ i.
     13 [1102b]~), this does not impose any necessity on the free
...
In ^De veritate~ q. 24, a. 1, ad 19 Aquinas explains:
     ...
     There is acquired from birth, howevwr, in the body of the
...
See Thomas Aquinas, ^Summa theol.~ I-II, q. 19, a. 4, resp.:
	...
	|76.  e libero voler~: See Thomas Aquinas, ^Summa theol.~
I-II, q. 17, a. 1, ad 2:
     ...
     the free will as being ^a free judgment aris^ing from
...
See also ^Purg.~ XVIII, 61-75; ^Par.~ V, 19-24.
	...
	|76-77.  che, se fatica... dura~: On these struggles
Thomas Aquinas (^Summa theol.~ I, q. 115, a. 4, ad 3) comments:
...
ipsum ^cogere.~" ("For this is the peculiar dignity of free will,
that, precisely as being free, it is subject to God alone;
...
precept.)
	...
	|81.  la mente~: The intellective soul.  |che 'l ciel non
ha in sua cura~: Here, as throughout, "ciel" means the heavens
and their movements.  See n. to vs. 63.  For ^avere in cura~, cf.
^Purg.~ XIII, 87.
...
of men.  |cheggia~ = ^chieda.~
	...
	|85.  Esce di mano a lui~: "L'anima semplicetta" (vs. 88)
is the subject of "esce."  "Hand" suggests God's fashioning the
soul, as it were, in creating it.

	|85-86.  la vagheggia prima che sia~: God is said to
contemplate the existence of the soul fondly before He actually
creates it.

	|86-87.  a guisa di fanciulla... pargoleggia~: The soul is
innocent and pure.
...
quoting Aristotle's ^De anima~, says:
     ...
     iii. 4[429b-430a]).  This is made clear from the fact that
	...
	|89.  salvo che~: This suggests that the soul's turning
in this sense is after all a kind of knowledge: it "knows" this
much at least.  |mossa~: "Mossa" suggests a "launching" of
the soul into existence.

	|89-90.  mossa da lieto fattore... trastulla~: The joy of
the Creator, in creating the soul He so fondly contemplates first
in idea, is communicated to it as a natural inclination, so that
it always seeks (turns to) that which can give it joy.  See
^Purg.~ XVIII, 55-60, and in general the argument of ^Purg.~ XVII
and XVIII.
...
compared with spiritual good.   |in pria~ = ^dapprima.~
	...
	|92-93.  s'inganna, e dietro... amore~: The soul, in
following its natural inclination to seek joy, is really seeking
to return to its Maker, the supreme Joy, though it does not know
this.  The whole passage here is closely parallel to ^Conv.~ IV,
xii, 14-18, where Dante explains:
	...
	|93.  se guida o fren non torce suo amore~: See
Augustine, ^De civ. Dei~ XII, xxii, 1-2:

     Verum haec hominum sunt malorum, ab illa tamen erroris et
     perversi amoris radice venientia, cum qua omnis filius Adam
     nascitur.  Nam quis ignorat cum quanta ignorantia veritatis,
...
VI, 88-89; ^Par.~ VI, 10-12).
	...
	|95.  convenne rege aver~: The king (in Dante's view the
universal monarch) is needed as a guide, the laws enforced by him
serving as the ^freno~, or "curb."

	|95-96.  che discernesse... la torre~: The image
transposes the notion of the soul guided by reason in its
"pilgrimage" in this life (see the quotation from the ^Convivio~
in n. to vss. 92-93) to that of mankind collectively engaged in
a pilgrimage.  The goal, or "city," for mankind collectively (and
following Dante's ideas as set forth in ^De monarchia~,
particularly in ^De mon.~ III, xvi, 7-11) is universal justice,
which under the perfect rule of the monarch should prevail, and
is synonymous with temporal felicity, the goal to which the
emperor is ordained to lead.  For this view of human society as
being engaged in a pilgrimage toward a goal, see Dante's ^Epist.~
XI, 26: "pro tota civitate peregrinante in terris" ("for the
whole estate of those on pilgrimage on earth") and ^passim~ in
^De monarchia.~
...
now to take the bridle in hand.  Cf. ^Purg.~ VI, 88-89.
	...
	|98.  Nullo~ = ^nessuno.~  In Dante's view Italy had had
no imperial guidance since the death of the Emperor Frederick II
in 1250.  See ^Conv.~ IV, iii, 6: "Federigo di Soave, ultimo
...
-- I say the last up to the present time.")
	...
	|98-99.  per@o che 'l pastor... fesse~: Spiritual rule is
...
mon.~ I, xvi, 1-2, where Dante says:
     ...
     felicitatis ministerium ministro vacavit.  All the reasons
     set forth above are confirmed by a memorable experience;
     namely, of that state of mortal things which the Son of God,
     when about to become man for man's salvation, either
     awaited, or, when he would, produced.  For if we go through
     all the states and periods of man, even from the fall of our
     first parents, which was the point at which we turned aside
...
Kantorowicz concludes (p. 231):
	...
	|109-110.  L'un l'altro ha spento... pasturale~: The pope as
one "Sun" has "quenched" the other by assuming the powers over temporal
affairs that righitly belong to the em peror, thus uniting the
emperor's "sword" to the ecclesiastical "crook."  See n. to vs. 98.

	|109.  giunta~ = ^congiunta.~

	|111.  per viva forza~: "Viva" reinforces the standing
phrase "per forza." ^mal convien che vada~: The normal word order
would be "convien che vada male," a singular subject (it, the
guidance) being understood.  ^Convenire~, as it often does,
states necessity here.

	|112.  per@o che~ = ^perci@o che.~  |giunti~ = ^congiunti~,
"united," in the one office of the papacy.  |l'un l'altro
non teme~: The sword does not fear the crook and vice versa;
...
respectively from Brescia, Treviso, and Reggio
nell'Emilia.  |riga~ = ^irriga.~
...
XVI, 67; ^Purg.~ VIII, 127-29; XIV, 90.  

	|117.   prima che Federigo avesse briga~: The expression ^aver
briga~ views the matter from the standpoint of the emperor.  In the
struggle of the papacy against Frederick II, last of the emperors
according to Dante (see n. to vs. 98), the papacy took up the sword,
which it should not have done.

	|118-120.  or pu@o sicuramente... d'appressarsi~: Anyone who,
because he is evil and degenerate, would seek to avoid the
company of good men may now pass through Lombardy without risk of
encountering any good men.  For the construction ^per~ with agent, see
^Inf.~ I, 126.  ^Lasciare~ in this use, meaning "to avoid" or "to
eschew," is commonly found in early Italian.  Compare the judgment on
this region with that on Romagna in ^Purg.~ XIV, 91-96.

	|121.  @en~ = ^enno~ (^sono~).  The plural is formed on the
singular ^@e~, by analogy with such verbs as ^sta, stanno. tre
vecchi ancora~: These men serve, in their rare virtue, as a
...
the stumps of his arms rather than abandon it.  |e 'l buon
Gherardo~: The son of Biaquino da Camino and India da
...
fact, pointed out by I. Del Lungo (1880, pp. 596 97 and n. 6),
...
109-11.  The Church has confounded (that is, confused in the
...
130.0 ^Marco mio~: Del Lungo notes that this is an affectionate
vocative indicating personal relationship, but that here it only
denotes cordial agreement.

	|131-132.  e or discerno... essenti~: The Levites, members
of the tribe of Levi, served as subordinate ministers of the
temple and are often spoken of as priests, although, strictly
...
example," a sample.
	...
	|135.  in rimprov@ero~: Cf. vss. 121-22.  Some editors
...
I am misled by what you say." ^el~: I.e., your speech. |mi
tenta~: "Would test me," or perhaps "would draw me out," "would
lead me on."
...
thesis concerning degeneration.
	...
	|140.  Gaia~: Gaia was the daughter of Gherardo da Camino
by his second wife, Chiara della Torre of Milan, and sister of
Rizzardo (^Par.~ IX, 50).  She married a relative, Tolberto da
Camino, and died in August of 1311.  She was buried at Treviso,
where, according to N. Barozzi (1865, p. 804), the remains of
her tomb outside the church of San Niccol@o were still to be seen
in the eighteenth century.  The commentators differ as to what is
...
by Dante (cf. ^Inf.~ XI, 41; XXIX, 125-32).  |nol~ = ^non lo.~
...
setting sun shines through the smoke enough to "whiten" it.
	...
	|143.  gi@a biancheggiare~: They now approach the edge of
the cloud of smoke which had overtaken them, and the light of the
sun increases in "whiteness."  (This is not the radiance of the
