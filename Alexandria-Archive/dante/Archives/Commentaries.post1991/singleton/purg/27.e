...
command (vs. 32).
	...
	|43.  croll@o la fronte~: Cf. Inf. XXII, 107: "crollando
'l capo."  The gesture expresses surprise or amazement, feigned,
of course, in this instance, since Virgil knows that the mention
of Beatrice has already had its calculated effect.
...
the setting sun at his back, casts a shadow before him.
	...
	|67.  E di pochi scaglion levammo i saggi~: Literally,
"and we took samples of only a few steps."  Porena comments:
     ...
     riconoscere la natura di questa, fare quello che oggi si
...
and 75.
	...
	|67-69.  E di pochi... saggi~: Dante's body casts a long
shadow, which can be seen by Virgil and Statius, who are in front
of him.  It fades out now as the sun sets.

	|68.  che~ = ^quando.~ 		|corcar~ = ^coricarsi.~ 
Cf. ^Purg.~ XVII, 9.
...
desire to see her own eyes.  See ^Conv.~ IV, ii, 18:
     ...
     contemplates herself when the beauty of her eyes is revealed
...
will not endure eternally as will the fire of Hell, but only
