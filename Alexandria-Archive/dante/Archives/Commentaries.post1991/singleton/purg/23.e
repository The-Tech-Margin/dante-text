...
this case, to the words that speak of praising God (Ps. 50:17
[51:15]): "Domine, labia mea aperies; et os meum annuntiabit
...
weeping causes compassionate grief.  Cf. vs. 10.
	...
	|13.  che @e quel ch'i' odo?~  Dante and Virgil are facing
ahead and so away from the crowd of souls who approach from
behind; hence Dante does not see them yet.
...
113-14), are marveling that Dante casts a shadow.  The sun is now
...
Ovid ends the tale of Erysichthon (^Metam.~ VIII, 875-78):
...
Josephus (^The Jewish War~ VI, 201-13), during the siege of
...
and non-classical incidents.
	...
	|30.  di@e~ = ^diede.~ 	|di@e di becco~: As if she were a
vulture or some carrion-eating bird.

	|31.  Parean l'occhiaie anella sanza gemme~: See
Shakespeare, ^King Lear~, Act V, sc. 3, ll. 188-90: 
...
should be construed: "Chi, non sappiendo como, crederebbe...."
	...
	|governasse~: Cf. "governo" in ^Inf.~ XVII, 47 and
...
other) on this terrace.  See ^Purg.~ XXIV, 106-7.
...
104.  	|sprazzo~: Cf. ^Purg.~ XXII, 137-38.

	|69.  su per~: See n. to ^Purg.~ XXII, 137-38.
...
alberi ci mena~: See ^Purg.~ XXIV, 106-11.
...
equal to that of their lives on earth (see ^Purg.~ IV, 130-34;
XI, 127-32).
...
ubera."  ("Because of heat ahd indecent custom they go clothed in
...
[Salimbene].")
	...
	|105.  0 spiritali o altre discipline~: The ^Ottimo
...
moon over the dark wood in ^Inf.~ XX, 127-29.
...
declared straight ("dritto") again.
	...
	|127-129.  Tanto dice... rimagna~: Cf. ^Inf.~ I, 112-23;
