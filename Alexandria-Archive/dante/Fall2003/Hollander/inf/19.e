...
St. Francis's order, 'primo sigillo a sua relig&#962;one' [the first 
...
the view that the assasin calls back the friar in order to save, not 
...
even Boniface in evil, as one 'di pi&#981; laida opra' (one even fouler 
...
(reigned 306-337) holds him responsible for the so-called 'Donation of 
Constantine,' by which he granted temporal sovereignty to Pope 
...
^Monarchia~ [III.x.1-9]).  In his view the emperor was not empowered to 
give over his authority; thus the document was truthful, but its 
...
^Inferno~ XVI.126-127: 'le note / di questa comed&#926;a' [the strains 
