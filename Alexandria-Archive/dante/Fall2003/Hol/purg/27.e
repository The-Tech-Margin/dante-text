...
(Jerusalem, Spain , India, the antipodes), Dante, like clocks on the 
wall in an air terminal, tells us the global condition of the time.  It 
...
5:8), 'Bless&#928;d are the clean of heart [for they shall see God].'
...
angel seems to be addressing 'bless&#928;d souls,' 
...
(^Purg.~ XXX.73).  Since Dante likes to use the rhythm of 9 \+ 1 to 
...
appears 63 times in the ^Comedy~, and that number is a 'nine' (6 \+ 3 = 
...
shall the King say unto them on his right hand, "Come, bless&#928;d of 
...
carries a banner that is inscribed 'Come, bless&#928;d of my Father, 
